    ...
    <div className="h-screen flex flex-col p-10 atmosphere overflow-hidden">
      <div className="flex items-center justify-between mb-12">
        <div className="space-y-1">
          ...
          <h2 className="text-4xl font-display font-bold text-white">Logic Sandbox</h2>
        </div>
        
        <div className="flex items-center gap-3">
           <Button variant="ghost" className="h-10 rounded-xl bg-white/5 text-white/40 hover:text-white">
              <Save className="w-4 h-4" />
              Save Environment
           </Button>
           <Button onClick={handleTest} disabled={isGenerating} className="mac-button-primary h-10 px-8">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-10 overflow-hidden">
        ...
        <div className="flex flex-col gap-6 overflow-hidden">
           <div className="glass-card flex-1 flex flex-col p-0 border-blue-500/10 bg-blue-500/[0.01]">
